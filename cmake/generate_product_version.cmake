...
function(generate_product_version outfiles)
    ...
    set (_VersionInfoFile ${CMAKE_CURRENT_BINARY_DIR}/include/${PRODUCT_NAME}/VersionInfo_${PRODUCT_NAME}.h)
    set (_VersionResourceFile ${CMAKE_CURRENT_BINARY_DIR}/include/${PRODUCT_NAME}/VersionResource_${PRODUCT_NAME}.rc)
    configure_file(
